@import url(https://fonts.googleapis.com/css?family=DM+Sans:400,500,700&display=swap&css);
...
.ant-btn[disabled]:active {
  color: #a1a1b5;
  background: rgba(213, 213, 226, 0.2);
  border-color: #d9d9d9;
  text-shadow: none;
  box-shadow: none;
}
...
.ant-btn-group .ant-btn-primary:not(:first-child):not(:last-child) {
  border-right-color: rgba(122, 119, 255, 0.5);
  border-left-color: rgba(122, 119, 255, 0.5);
}
...
.ant-picker-calendar-full .ant-picker-panel .ant-picker-cell-selected:hover .ant-picker-calendar-date-today {
  background: rgba(122, 119, 255, 0.9);
}
...
.ant-cascader-picker:focus .ant-cascader-input {
  ...
  outline: 0;
  box-shadow: 0 0 0 2px rgba(122, 119, 255, 0.2);
}
...
.ant-cascader-picker-label:hover + .ant-cascader-input:not(.ant-cascader-picker-disabled .ant-cascader-picker-label:hover + .ant-cascader-input) {
  border-color: rgba(122, 119, 255, 0.5);
  border-right-width: 1px !important;
}
...
.ant-cascader-menu-item-active:not(.ant-cascader-menu-item-disabled):hover {
  font-weight: 600;
  background-color: rgba(122, 119, 255, 0.9);
}
...
.ant-checkbox-disabled .ant-checkbox-inner {
  background-color: rgba(213, 213, 226, 0.2);
  border-color: #d9d9d9 !important;
}
.ant-checkbox-disabled .ant-checkbox-inner::after {
  border-color: rgba(213, 213, 226, 0.2);
  border-collapse: separate;
  animation-name: none;
}
...
.ant-picker-cell-in-view.ant-picker-cell-range-hover:not(.ant-picker-cell-in-range)::after {
  ...
  z-index: 0;
  height: 24px;
  border-top: 1px dashed #deddff;
  border-bottom: 1px dashed #deddff;
  transform: translateY(-50%);
  content: '';
}
...
.ant-picker-cell-in-view.ant-picker-cell-range-hover-end::after {
  right: 6px;
  border-right: 1px dashed #deddff;
  border-top-right-radius: 4px;
  border-bottom-right-radius: 4px;
}
.ant-picker-cell-disabled {
...
.ant-picker-time-panel-column-active {
  background: rgba(122, 119, 255, 0.2);
}
...
.ant-picker-ranges .ant-picker-preset > .ant-tag-blue {
  color: #7a77ff;
  background: rgba(122, 119, 255, 0.9);
  border-color: rgba(122, 119, 255, 0.7);
  cursor: pointer;
}
...
.ant-form-item-has-warning .ant-select:not(.ant-select-borderless)-focused,
.ant-form-item-has-warning .ant-select:not(.ant-select-borderless):focus {
  border-color: #ffc53d;
  border-right-width: 1px !important;
  outline: 0;
  box-shadow: 0 0 0 2px rgba(250, 173, 20, 0.2);
...
.ant-form-item-has-error .ant-select:not(.ant-select-borderless)-focused,
.ant-form-item-has-error .ant-select:not(.ant-select-borderless):focus {
  border-color: #ff7875;
  border-right-width: 1px !important;
  outline: 0;
  box-shadow: 0 0 0 2px rgba(255, 77, 79, 0.2);
...
.ant-menu-submenu-inline > .ant-menu-submenu-title .ant-menu-submenu-arrow::after {
  ...
  width: 6px;
  height: 1.5px;
  background-image: linear-gradient(to right, #5b5c7d, #5b5c7d);
  border-radius: 2px;
...
.ant-menu-submenu-inline > .ant-menu-submenu-title:hover .ant-menu-submenu-arrow::before {
  background: linear-gradient(to right, #141446, #141446);
}
.ant-menu-submenu-vertical > .ant-menu-submenu-title .ant-menu-submenu-arrow::before,
.ant-menu-submenu-vertical-left > .ant-menu-submenu-title .ant-menu-submenu-arrow::before,
.ant-menu-submenu-vertical-right > .ant-menu-submenu-title .ant-menu-submenu-arrow::before {
...
.ant-menu-horizontal:not(.ant-menu-dark) > .ant-menu-submenu-selected {
  color: #141446;
  border-bottom: 2px solid #141446;
}
.ant-menu-horizontal > .ant-menu-item,
.ant-menu-horizontal > .ant-menu-submenu {
  position: relative;
...
.ant-pagination.ant-pagination-disabled .ant-pagination-item-active {
  background: rgba(183, 183, 205, 0.2);
  border-color: transparent;
}
...
.ant-radio-input:focus + .ant-radio-inner {
  box-shadow: 0 0 0 3px rgba(122, 119, 255, 0.08);
}
...
.ant-radio-button-wrapper-checked:not(.ant-radio-button-wrapper-disabled):hover::before {
  background-color: rgba(122, 119, 255, 0.5);
}
.ant-radio-button-wrapper-checked:not(.ant-radio-button-wrapper-disabled):active {
  color: rgba(122, 119, 255, 0.3);
  border-color: rgba(122, 119, 255, 0.3);
}
.ant-radio-button-wrapper-checked:not(.ant-radio-button-wrapper-disabled):active::before {
  background-color: rgba(122, 119, 255, 0.3);
}
...
.ant-radio-group-solid .ant-radio-button-wrapper-checked:not(.ant-radio-button-wrapper-disabled):hover {
  color: #fff;
  background: rgba(122, 119, 255, 0.5);
  border-color: rgba(122, 119, 255, 0.5);
}
.ant-radio-group-solid .ant-radio-button-wrapper-checked:not(.ant-radio-button-wrapper-disabled):active {
  color: #fff;
  background: rgba(122, 119, 255, 0.3);
  border-color: rgba(122, 119, 255, 0.3);
}
...
.ant-slider-track {
  position: absolute;
  height: 4px;
  background-color: rgba(122, 119, 255, 0.7);
  border-radius: 4px;
  transition: background-color 0.3s;
}
.ant-slider-handle {
  ...
  margin-top: -5px;
  background-color: #fff;
  border: solid 2px rgba(122, 119, 255, 0.7);
  border-radius: 50%;
  box-shadow: 0;
  cursor: pointer;
...
.ant-slider-handle-dragging.ant-slider-handle-dragging.ant-slider-handle-dragging {
  border-color: #9592ff;
  box-shadow: 0 0 0 5px rgba(122, 119, 255, 0.12);
}
...
.ant-slider:hover .ant-slider-track {
  background-color: rgba(122, 119, 255, 0.6);
}
.ant-slider:hover .ant-slider-handle:not(.ant-tooltip-open) {
  border-color: rgba(122, 119, 255, 0.6);
}
.ant-slider-mark {
  position: absolute;
  top: 14px;
...
.ant-slider-disabled .ant-slider-track {
  background-color: #a1a1b5 !important;
}
.ant-slider-disabled .ant-slider-handle,
.ant-slider-disabled .ant-slider-dot {
  background-color: #fff;
  border-color: #a1a1b5 !important;
  box-shadow: none;
  cursor: not-allowed;
}
...
.ant-switch:focus {
  outline: 0;
  box-shadow: 0 0 0 2px rgba(161, 161, 181, 0.1);
}
...
.ant-table-tbody > tr.ant-table-row-selected:hover > td {
  background: rgba(112, 109, 255, 0.9);
}
.ant-table tfoot > tr > th,
.ant-table tfoot > tr > td {
  border-bottom: 1px solid #f0f0f0;
...
.ant-tag-checkable-checked {
  background-color: rgba(122, 119, 255, 0.4);
}
.ant-tag-checkable:active {
  background-color: rgba(122, 119, 255, 0.3);
}
...
.ant-transfer-list-content-item:not(.ant-transfer-list-content-item-disabled).ant-transfer-list-content-item-checked:hover {
  background-color: rgba(112, 109, 255, 0.9);
}
...
.ant-tree .ant-tree-node-content-wrapper.ant-tree-node-selected {
  background-color: rgba(122, 119, 255, 0.8);
}
...
.ant-tree-rtl.ant-tree-switcher-loading-icon {
  transform: scaleY(-1);
}
