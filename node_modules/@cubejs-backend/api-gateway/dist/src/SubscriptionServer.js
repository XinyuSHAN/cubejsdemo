...
class SubscriptionServer {
    ...
    async processMessage(connectionId, message, isSubscription) {
        ...
        try {
            ...
            await this.apiGateway[method](Object.assign(Object.assign({}, params), { context,
                isSubscription, res: this.resultFn(connectionId, message.messageId), subscriptionState: async () => {
